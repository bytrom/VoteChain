...
const GSCulturalCandidates: React.FC = () => {
    ...
    const fetchCandidates = async () => {
      ...
      try {
        const res = await fetch(
          "http://localhost:5000/api/candidate/approved?position=GS(CULTURAL)"
        );
        const data = await res.json();
...
export default GSCulturalCandidates;
