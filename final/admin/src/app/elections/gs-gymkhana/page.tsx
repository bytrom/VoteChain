...
const GSGymkhanaCandidates: React.FC = () => {
    ...
    const fetchCandidates = async () => {
      ...
      try {
        const res = await fetch(
          "http://localhost:5000/api/candidate/approved?position=GS(GYMKHANA)"
        );
        const data = await res.json();
...
export default GSGymkhanaCandidates;
