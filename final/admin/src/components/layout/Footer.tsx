...
const Footer = () => {
  return (
    <footer className="relative backdrop-blur-sm bg-gradient-to-r from-[#0b0f1a] to-[#05080f] border-t border-white/10">
      {/* Red line decoration */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Revolutionizing college elections with blockchain technology. Secure, transparent, and trustworthy voting system.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#key-features" className="text-gray-400 hover:text-red-400 transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/#how" className="text-gray-400 hover:text-red-400 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
                <Link href="/events" className="text-gray-400 hover:text-red-400 transition-colors">
                  Events
                </Link>
              </li>
            </ul>
